...
function OfficeDashboardTable({ comments, dashboard }) {
          ...
          <tbody>
            {commentsData.map((value, i) => (
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                {roleId === 2 && (
                  <td className="px-6 py-4">
                    {value.user_type === "local_government"
                ...
                <td className="px-6 py-4 flex justify-between">
                  <div className="flex gap-4">
                    {parseInt(roleId) === 2 ? (
                      <Link
                        to={`/information-collection-detail/${value.id}`}
                      ...
                      // If Role is Local/Ministry CAO, Officer
                      <Link
                    ...
                    {(parseInt(roleId) !== 8 || parseInt(roleId) !== 2) &&
...
export default OfficeDashboardTable;
